...
public class ElectrodomesticosApp {
    ...
    public static void main(String[] args) {
        ...
        listaElectrodomesticos[0]=new Electrodomestico(200, 60, 'C', "Gris");
        ...
        listaElectrodomesticos[7]=new Lavadora(400, 100, 'A', "azul", 15);
        ...
        for(int i=0;i<listaElectrodomesticos.length;i++){
            ...
            if(listaElectrodomesticos[i] instanceof Television){
                System.out.println("Televisor-->"+listaElectrodomesticos[i].toString());
            }
            else if(listaElectrodomesticos[i] instanceof Lavadora){
                
                System.out.println("Lavadora-->"+listaElectrodomesticos[i].toString());
            }
            else{ 
        
                System.out.println("Electrodomestico-->"+listaElectrodomesticos[i].toString());
            }

            
        }
        //Descomenta esto sino entiendes como calculo si las letras son válidas
        //char letraA=65;
        //char letraF=70;
        //System.out.println(letraA+" "+letraF); // esto imprime una A y una F
        
        //Mostramos los resultados
        System.out.println("\n\nLa suma del precio de los electrodomesticos es de "+sumaElectrodomesticos);
